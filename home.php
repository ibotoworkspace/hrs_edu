      ...
      <div class="container">
          ...
          <div class="col-sm-12">
            <div class="pointbox">
              <div class="pointboximg">
                <img src="images/intensive.png" class="img-responsive">
              </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="pointbox">
              <div class="pointboximg">
                <img src="images/quizes.png" class="img-responsive">
              </div>
              <div class="pointboxdata">
                <h3 class="double">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="pointbox">
              <div class="pointboximg">
                <img src="images/premium.png" class="img-responsive">
              </div>
              <div class="pointboxdata">
                <h3 class="doubles">
       ...
       <div class="container">
         ...
         <div class="row">
           <div class="col-sm-4">
             <div class="coursebox">
               <div class="courseboximg">
                <img src="images/securitypro.png" class="img-responsive">
               </div>
           ...
           <div class="col-sm-4">
            <div class="coursebox">
              <div class="courseboximg">
               <img src="images/ethicalhacking.png" class="img-responsive">
              </div>
              <div class="courseboxsdata">
                <h4>
                  ETHICAL HACKING
          ...
          <div class="col-sm-4">
            <div class="coursebox">
              <div class="courseboximg">
               <img src="images/networkpro.png" class="img-responsive">
              </div>
              <div class="courseboxsdata">
                <h4>
                  NETWORK PRO
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="studentsimg">
              <img src="images/joinourstudent.png" class="img-responsive">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
          ...
          <div class="col-sm-12">
            <div class="demandbox">
              <div class="demandboximg">
                <img src="images/image-06.png" class="img-responsive">
              </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="demandbox">
              <div class="demandboximg">
                <img src="images/image-07.png" class="img-responsive">
              </div>
              <div class="demandboxdata">
                <h4>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="demandbox">
              <div class="demandboximg">
                <img src="images/image-08.png" class="img-responsive">
              </div>
              <div class="demandboxdata">
                <h4 class="smallright">
