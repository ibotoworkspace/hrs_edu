    ...
    <div class="coursesback">
        ...
        <div class="row">                
            <div class="col-sm-4">
                <div class="coursesbox">
                    <div class="coursesboximg">
                        <img src="images/courses1.png" class="img-responsive">
                    </div>
            ...
            <div class="col-sm-4">
                <div class="coursesbox">
                    <div class="coursesboximg">
                        <img src="images/courses2.png" class="img-responsive">
                    </div>
                    <div class="coursesboxdata">
            ...
            <div class="col-sm-4">
                <div class="coursesbox">
                    <div class="coursesboximg">
                        <img src="images/courses3.png" class="img-responsive">
                    </div>
                    <div class="coursesboxdata">
                        <h3>HRS LINUX PRO</h3>
        ...
        <div class="row onerow">                
            <div class="col-sm-4">
                <div class="coursesbox">
                    <div class="coursesboximg">
                        <img src="images/courses4.png" class="img-responsive">
                    </div>
                    <div class="coursesboxdata">
                        <h3>HRS PC PRO</h3>
            ...
            <div class="col-sm-4">
                <div class="coursesbox">
                    <div class="coursesboximg">
                        <img src="images/courses5.png" class="img-responsive">
                    </div>
                    <div class="coursesboxdata">
            ...
            <div class="col-sm-4">
                <div class="coursesbox">
                    <div class="coursesboximg">
                        <img src="images/courses6.png" class="img-responsive">
                    </div>
                    <div class="coursesboxdata">
        ...
        <div class="row onerow">                
            <div class="col-sm-4">
                <div class="coursesbox">
                    <div class="coursesboximg">
                        <img src="images/courses7.png" class="img-responsive">
                    </div>
                    <div class="coursesboxdata">
            ...
            <div class="col-sm-4">
                <div class="coursesbox">
                    <div class="coursesboximg">
                        <img src="images/courses8.png" class="img-responsive">
                    </div>
                    <div class="coursesboxdata">
            ...
            <div class="col-sm-4">
                <div class="coursesbox">
                    <div class="coursesboximg">
                        <img src="images/courses9.png" class="img-responsive">
                    </div>
                    <div class="coursesboxdata">
        ...
        <div class="row onerow">                
            <div class="col-sm-4">
                <div class="coursesbox">
                    <div class="coursesboximg">
                        <img src="images/courses10.png" class="img-responsive">
                    </div>
                    <div class="coursesboxdata">
