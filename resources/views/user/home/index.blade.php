                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="fstbannerdata">
                            <h1>PROCESS <span class="bannertext">IMPROVEMENT</span> <br> AND PROFESSIONAL <br> <span
                                    class="bannertext">ACQUISITIONS</span></h1>
                        </div>
                        <div class="bannerclick">
                            ...
                            <a href="{{ asset('student/registration') }}"><button type="button"
                                    class="btn btn-primary enroll">ENROLL NOW</button></a>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="bannerimg">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="courseclick">
                            <a href="{{ asset('user/courses') }}" type="button" class="btn btn-primary courses">VIEW ALL
                                COURSES</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="demanddata">
                            ...
                            <p>Get Certified with our on-demand professional training that open doors <br> to opportunities
                                you can easily leverage from within your location.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="demandbox">
                            ...
                            <div class="demandboxdata">
                                ...
                                <p>
                                    Build and acquire relevant skills and portfolio for professional acceptance and equal
                    ...
                    <div class="col-sm-12">
                        <div class="demandbox">
                            ...
                            <div class="demandboxdata">
                                ...
                                <p>
                                    Our job is to provide you with the right learning platform so you can easily pursue your
                                    passion and succeed in your professional field.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="demandbox">
                            ...
                            <div class="demandboxdata">
                                ...
                                <p class="smallright">
                                    Our in-house professionals certified trainers are always on stand by to impact
                                    incredible knowledge with first hand information that guarantees your success.
                                </p>
                            </div>
                        </div>
                    </div>
