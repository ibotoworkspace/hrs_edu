...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
  <a href="{{asset('javascript:void(0)')}}" onclick="w3_close()" class="w3-right w3-xlarge w3-padding-large w3-hover-black w3-hide-large" title="Close Menu">
    ...
    <div class="leastfooter">
      <div class="container">
        <div class="row">
          <div class="col-sm-8">
            <div class="copydata">
              <p>Copyright © 2020 HRS Academy | All Rights Reserved | Designed by <a href="{{asset('https://hatinco.com/')}}" target="_blank" > HATINC.</a></p>
            </div>
          </div>
          <div class="col-sm-4">
