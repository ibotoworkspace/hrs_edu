...
<head>
    <title>skilladvisor DashBoard</title>
    <meta charset="utf-8">
...
<body>
    ...
    <nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
        ...
        <ul class="nav navbar-nav side-nav mysidemenu">
            <li>
                <a href="{{ asset('skilladvisor/dashboard') }}"> Dashboard</a>
            </li>
            <li>
                <a href="{{ asset('skilladvisor/profile') }}"> Profile</a>
            </li>

            {{-- <li>
                <a href="{{ asset('skilladvisor/mygroup') }}"> My Students</a>
            </li> --}}
            {{-- <li>
                <a href="{{ asset('skilladvisor/changepassword') }}"> Change Password</a>
            </li> --}}
            <li>
                <a href="{{ asset('skilladvisor/logout') }}"> Logout</a>
            </li>
        </ul>
