...
<div class="col-sm-12">
<div class="plsbtn"><button type="button" class="btn btn-primary " id="plsbtn"><span class="plus">+</span> Add Choices</button></div>
</div>
...
<div class="mysave"><button type="button" class="btn btn-primary " id="mysave">Save</button></div>
  ...
  <div class="col-sm-6">
<div class="mysaveer"><button type="button" class="btn btn-primary " id="mysaveer">Reset</button></div>
</div>
  </div> 
  </div>
  </div>
